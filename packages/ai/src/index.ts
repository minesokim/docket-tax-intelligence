...
export function synthesizeTaxChatWithClaude(input: TaxChatSynthesisInput): TaxChatSynthesisOutput | null {
  ...
  const prompt = [
    ...
    "For return-position questions, also think defensively. Surface preparer exposure under §6694, client exposure under §6662, and the available protection path when relevant: Form 8275 or 8275-R disclosure, reasonable-basis vs. substantial-authority standards, strict-substantiation regimes like §274(d), contemporaneous record reconstruction, and reasonable-cause/good-faith defenses. If a weak position could be protected by disclosure, say that; if disclosure cannot cure missing substantiation, say that too.",
