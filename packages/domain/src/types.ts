...
export const DocumentClassSchema = z.enum([
  ...
  "FORM_1095_A",
  "SCHEDULE_K1",
  "CRYPTO_TAX_LOT_REPORT",
  "STATE_ALLOCATION_WORKPAPER",
  "DEPENDENT_CARE_STATEMENT",
  "MILEAGE_LOG",
  ...
  professionalAnalyses: z
    .array(
      z.object({
        ...
        clientCommunicationDraft: z.string(),
        preparerWorkPlan: z.array(z.string()),
        sourceIds: z.array(z.string()),
        citationIds: z.array(z.string()),
      }),
    )
